              ...
              <div className="bg-white rounded-xl max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {'githubUrl' in selectedProjectData && selectedProjectData.githubUrl && (
                      <a
                    ...
                    {'liveUrl' in selectedProjectData && selectedProjectData.liveUrl && (
                      <a
                    ...
                    {'demoUrl' in selectedProjectData && selectedProjectData.demoUrl && (
                      <a
