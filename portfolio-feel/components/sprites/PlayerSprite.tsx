...
export default function PlayerSprite({
  ...
  const getPlayerStyles = () => {
    ...
    const adjustedY = state === 'landing' ? y + height * (1 - scaleY) : y;
    ...
    const baseStyles = {
      ...
      width: `${width}px`,
      height: `${height}px`,
      transform: `scaleX(${flipX}) scaleY(${scaleY})`,
        ...
        {state === 'crouching' ? (
          ...
          <>
            ...
            {state === 'walking' && frame % 2 === 1 ? (
              ...
              <>
                <rect x="9" y="43" width="7" height="5" fill={overallsColor} stroke="#000" strokeWidth="1"/>
                <rect x="16" y="43" width="7" height="5" fill={overallsColor} stroke="#000" strokeWidth="1"/>
              </>
            ) : (
              <>
